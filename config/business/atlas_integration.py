...
def integration_topology() -> dict[str, Any]:
    ...
    return {
        ...
        "baWorktree": ".worktrees/hvcg-business-architecture-v2",
        "baBranch": "cursor/hvcg-business-architecture-v2",
        "eliteWorktree": ".worktrees/atlas-usable-operating-layer",
        "eliteBranch": "fix/atlas-usable-operating-layer",
        "productionBranch": "main",
        "productionHardeningWorktree": ".worktrees/atlas-integration-release",
        "productionHardeningBranch": "fix/atlas-production-hardening",
        "integrationPolicy": "BA branch holds sequential BA V2 sprint lineage; Elite paired by SHA. No Production merge.",
