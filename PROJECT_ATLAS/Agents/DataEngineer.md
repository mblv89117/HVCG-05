...
**As of:** 2026-07-20  
**Orchestration agentId:** `data-engineering` (**registered** — Sprint 12)  
**Registration evidence:** [../Documentation/SPRINT12_DATA_ENGINEERING_REGISTRATION.md](../Documentation/SPRINT12_DATA_ENGINEERING_REGISTRATION.md)  
**Comms / worktree:** Sample-data, schema snapshots, CRM import shells, SharePoint schema scripts  
**Orchestration ownedPaths:** `sample-data/`, `releases/migrations/`
...
2. `bash scripts/orchestration/list-ready.sh --agent data-engineering`
3. Claim Ready work before editing `sample-data/` or `releases/migrations/`; otherwise heartbeat `Idle`.
4. Never load sample data to Production.
...
3. Run orchestration `list-ready` for `data-engineering` before inventing work.
4. Read DATA_DICTIONARY + PILOT_IMPORT materials + Deployment SP list status.
