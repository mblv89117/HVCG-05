...
|-------------|--------|-------|
| Atlas Elite (production SWA) | Live — Command Center honesty UI | Unimplemented Initialize / Quick Capture / sync / archive labeled; not presented as working |
| Atlas Hub (production App Service) | Live | SharePoint PM via `id-atlas-prod`; Graph collection reads without `$filter`; BA configured/reachable |
