...
const allSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'communication-policies', label: 'CommunicationPolicies', to: '/communication-policies', icon: <ApprovalsAppRegular /> },
...
const catalog: SearchResult[] = [
  ...
  { id: 's-communication-policies', title: 'CommunicationPolicies', category: 'Operations', subtitle: 'Recorded comms policy — Approval Center remains the approval path', to: '/communication-policies' },
...
const routeLabels: Record<string, string> = {
  ...
  '/communication-policies': 'CommunicationPolicies',
