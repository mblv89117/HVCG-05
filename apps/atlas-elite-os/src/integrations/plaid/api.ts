...
export interface AtlasPlaidAuthHeaders {
  userId: string;
...
function headers(auth: AtlasPlaidAuthHeaders): HeadersInit {
  return {
...
export async function fetchConnections(auth: AtlasPlaidAuthHeaders, clientId: string) {
...
export async function createLinkToken(auth: AtlasPlaidAuthHeaders, clientId: string) {
...
export async function syncConnection(auth: AtlasPlaidAuthHeaders, clientId: string, connectionId: string) {
...
export async function fetchCashSnapshot(auth: AtlasPlaidAuthHeaders, clientId: string, clientCode: string) {
