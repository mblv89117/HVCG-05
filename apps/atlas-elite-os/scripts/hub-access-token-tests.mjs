...
assert.match(liveDetail, /engagementsListHonesty/);
assert.match(liveDetail, /engagementsChipLabel/);
assert.match(liveDetail, /\{engagementsHonesty\.sentence\}/);
assert.doesNotMatch(liveDetail, /workspace\.engagements\.items/);
assert.match(liveDetail, /deliverablesListHonesty/);
assert.match(liveDetail, /deliverablesChipLabel/);
