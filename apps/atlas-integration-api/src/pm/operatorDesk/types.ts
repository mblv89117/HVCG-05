...
export const ASK_ATLAS_CAPITAL_SUBMISSION_HONESTY_MISSION_KEY =
  'ATLAS-CAPITAL-SUBMISSION-HONESTY-001' as const;
export const ASK_ATLAS_APPROVAL_CENTER_HONESTY_MISSION_KEY =
  'ATLAS-APPROVAL-CENTER-HONESTY-001' as const;
export const ASK_ATLAS_COMMUNICATION_POLICY_HONESTY_MISSION_KEY =
  'ATLAS-COMMUNICATION-POLICY-HONESTY-001' as const;
export const ASK_ATLAS_RESEARCH_INTELLIGENCE_MISSION_KEY =
  'ATLAS-RESEARCH-INTELLIGENCE-001' as const;
export const ASK_ATLAS_RESEARCH_INTELLIGENCE_HONESTY_MISSION_KEY =
  'ATLAS-RESEARCH-INTELLIGENCE-HONESTY-001' as const;
export const ASK_ATLAS_ONBOARDING_AGENT_MISSION_KEY = 'ATLAS-ONBOARDING-AGENT-001' as const;
export const ASK_ATLAS_ONBOARDING_EXECUTE_HONESTY_MISSION_KEY =
  'ATLAS-ONBOARDING-EXECUTE-HONESTY-001' as const;
export const ASK_ATLAS_CLIENT_SUPPORT_AGENT_MISSION_KEY = 'ATLAS-CLIENT-SUPPORT-AGENT-001' as const;
export const ASK_ATLAS_CLIENT_SUPPORT_HONESTY_MISSION_KEY =
  'ATLAS-CLIENT-SUPPORT-HONESTY-001' as const;
...
export function isOperatorWorkflowTemplatesPath(path: string): boolean {
...
export function isOperatorCommunicationPoliciesPath(path: string): boolean {
