 ...
 * SharePoint is not the client UX. This store is the logical workspace.
 * Fail-closed: no wildcard, no cross-client reads.
 */
...
export type ActivationGate = 'authorized' | 'verified';
