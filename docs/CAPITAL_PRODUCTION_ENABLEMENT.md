...
**LIVE overlay (2026-08-19):** Hub zip `b333fb4` / Azure deploy `5d3826c0-f784-41da-9043-6912e63e122e` reports `/health` `capitalBackend.mode=sharepoint`. Confirmation-gate P1 **CLOSED**. **ACCG01 ACL Apply was not run.** This docs branch does not deploy Hub and does not run Enable `-Apply`. CRM operator is this LIVE Hub zip; Owner-browser `/leads` PASS. Capital Elite `b9806bc` is in SWA `2a4e115`, not this Hub zip.
...
| LIVE Hub `/health` (2026-08-19) | `capitalBackend.mode=sharepoint` on `b333fb4` / deploy `5d3826c0-f784-41da-9043-6912e63e122e` | keep observing `/health` after any later zip | **no Hub zip from this docs branch** | Capital Elite `b9806bc` is in SWA `2a4e115`, not this Hub zip |
