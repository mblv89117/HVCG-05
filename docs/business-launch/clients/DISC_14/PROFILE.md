# Client Profile — 3D Printing LLC

**ClientCode:** `DISC_14`  
**Discovery name:** 3D Printing LLC  
...
- `/Users/macminipro/Library/CloudStorage/OneDrive-highvaluesolution.com/High Value Solution/3D Printing LLC`
