# Client Profile — LV Appraisals

**ClientCode:** `DISC_04_ARCH`  
**Discovery name:** comp-LV Appraisals  
...
| Field | Value |
|-------|-------|
| Legal name | LV Appraisals |
| Classification | HVS_LEGACY_CLIENT |
| Contracting entity | **MISSING** |
...
Website/marketing docs — confirm client vs prospect — **ARCHIVE duplicate folder**
...
- `/Users/macminipro/Library/CloudStorage/OneDrive-highvaluesolution.com/High Value Solution LLC/OPERATIONS/CLIENTS/Archive/comp-LV Appraisals`
...
- May be marketing-only prospect
...
- Onboarding: `HUB_DISCOVERY_ONBOARDING_PACKETS.md § LV Appraisals`
- CRM shell: `crm-import/LVAP01_dev_shell.json`
