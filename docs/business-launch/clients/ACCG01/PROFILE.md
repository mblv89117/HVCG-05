# Client Profile — ACCG Inc.

**ClientCode:** `ACCG01`  
**Discovery name:** ACCG Inc  
...
| Contracting entity | High Value Solution LLC (HVCG SOW draft on file — unverified) |
| Discovery sources | HVS_Hub_Client_Files |
...
Fractional CFO / Capital Advisory — active legacy HVS; HVCG transition draft exists
...
Active capital advisory; $10M corporate complex financing referenced in HVCG SOW draft — **UNVERIFIED**

---

## 7. Communication history

Local email/msg files: **1** — Graph/Outlook **BLOCKED_CREDENTIALS**
...
- `/Users/macminipro/Library/CloudStorage/OneDrive-highvaluesolution.com/HVS Hub - Documents/4_Engagements/00_Client Files/ACCG Inc`
...
MSA draft 12-month initial term if executed; Access Plus month-to-month pattern observed

---

## 12. Cross-sell opportunities

Future: SKU-CAP-GROWTH, SKU-CAP-ENT, agentic AI/ROS (per HVCG SOW draft — not current price)
...
- Onboarding: `ACCG_ONBOARDING_PACKET.md`
- CRM shell: `crm-import/ACCG01_dev_shell.json`
